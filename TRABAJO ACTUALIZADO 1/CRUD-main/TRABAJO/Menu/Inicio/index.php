...
<html lang="es">
	...
	<div class="contenido"> <! CONTENIDO >
				...
				<div class="fecha">		</div>
						...
						¡Empecemos a explorar las posibilidades que tenemos a nuestra disposición para hacer de nuestra biblioteca un lugar más eficiente y acogedor para todos!</p>
		...
		<div class="enlaces"> <! ENLACES >
					...
					<ul>
							<li class="lista"><a>Añadir clientes</a></li>
							<li class="lista"><a>Borrar clientes </a></li>
							<li class="lista"><a>Añadir libros</a></li>
							<li class="lista"><a>Borrar libros</a></li>
							<li class="lista"><a>Añadir categorias</a></li>
							<li class="lista"><a>Borrar categorias</a></li>
							<li class="lista"><a>Mostrar los datos</a></li>
					</ul>
		</div>
	</div>
